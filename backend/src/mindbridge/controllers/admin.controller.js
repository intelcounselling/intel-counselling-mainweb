...
// Mark an appointment as done (or move it back/around between statuses).
async function updateAdminAppointmentStatus(req, res) {
  try {
    const { id } = req.params;
    ...
    handleError(res, err, 'updateAdminAppointmentStatus');
  }
}
