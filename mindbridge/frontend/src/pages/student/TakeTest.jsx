      ...
      <div className="max-w-3xl w-full p-10 animate-slide-up bg-white rounded-[2.5rem] shadow-2xl relative z-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between mt-10 gap-4">
          <button 
            onClick={handlePrev} 
            disabled={currentQ === 0}
            className={`w-full sm:w-auto px-6 py-4 rounded-xl font-bold flex items-center justify-center gap-2 transition-all ${
              currentQ === 0 ? 'opacity-0 pointer-events-none' : 'bg-surface-100 text-surface-600 hover:bg-surface-200'
            }`}
          >
          ...
          <button
            ...
            className={`w-full sm:w-auto px-8 py-4 rounded-xl font-bold flex items-center justify-center gap-3 transition-all duration-300 ${
              !answered 
