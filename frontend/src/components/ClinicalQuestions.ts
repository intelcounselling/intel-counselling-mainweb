...
export const CLINICAL_CONFIGS: Record<string, ClinicalConfig> = {
  ...
  sas: {
    id: 'sas',
    title: 'Smartphone Addiction Screening',
    desc: 'Self-reflection screening tool to assess smartphone usage and digital habits.',
    introPrefix: 'Over the last 2 weeks, how often have you experienced the following?',
    color: 'bg-[#4361EE]',
    options: [
      { label: 'Never', value: 0 },
      { label: 'Rarely', value: 1 },
    ...
    questions: [
      { id: 1, text: 'I feel restless or uncomfortable when I cannot use my phone' },
      { id: 2, text: 'I use my phone longer than I intended' },
      { id: 3, text: 'I find it difficult to control or reduce my phone usage' },
      { id: 4, text: 'My phone use affects my sleep quality' },
      { id: 5, text: 'I check my phone even without notifications' },
      { id: 6, text: 'I feel distracted due to phone usage' },
      { id: 7, text: 'I use my phone to escape stress or negative emotions' },
      { id: 8, text: 'I delay or neglect important tasks because of phone use' },
      { id: 9, text: 'People around me complain about my phone usage' },
      { id: 10, text: 'I feel uneasy when I am without my phone' },
    ],
    bands: [
      { min: 0, max: 10, label: 'Healthy Use', desc: 'Your responses suggest healthy smartphone usage patterns. You are likely maintaining a good balance between digital use and daily activities.', ctaText: 'Explore Healthy Digital Habits' },
      { min: 11, max: 20, label: 'Mild Overuse', desc: 'Your responses suggest mild overuse of your smartphone. You may occasionally rely on your phone more than necessary. Small changes in usage habits can improve focus and well-being.', ctaText: 'Improve My Screen Habits' },
      { min: 21, max: 30, label: 'Moderate Dependency', desc: 'Your responses indicate moderate dependence on smartphone usage. This may be affecting your concentration, sleep, or daily routine. Developing structured usage patterns can help regain control.', ctaText: 'Book a Digital Balance Session' },
      { min: 31, max: 40, label: 'High Dependency', desc: 'Your responses suggest high smartphone dependency. Your usage may be significantly affecting your daily functioning and well-being. Professional guidance can help you build healthier digital habits.', ctaText: 'Speak to a Counsellor Today' }
    ]
  }
};
